...
def user():
    ...
    fileName = r"C:\Users\Indra\Downloads\Kp\Project\pulang\keluar_" + date + "_" + Hour + "-" + Minute + "-" + Second + ".csv"
    ...
    res = "Keluar"
    E1.configure(text=res)
    tk.messagebox.showinfo('Keluar','sudah masuk, Terimakasih ... ')
...
B2 = tk.Button(window, text = "Pulang", command = user)
